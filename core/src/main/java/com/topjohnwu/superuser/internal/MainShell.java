...
public final class MainShell {
    ...
    public static Shell.Job newJob(boolean _02su, InputStream in) {
        return new PendingJob(_02su).add(in);
    }

    public static Shell.Job newJob(boolean _02su, String... cmds) {
        return new PendingJob(_02su).add(cmds);
    }
}
